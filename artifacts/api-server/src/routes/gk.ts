...
const QUESTIONS: Record<string, GKQuizQuestion[]> = {
  ...
  "current-affairs": [
    { id: "ca-q1",  topicId: "current-affairs", difficulty: "easy",   question: "Ram Mandir was inaugurated in January 2024 in which city?",                  options: ["Varanasi", "Mathura", "Ayodhya", "Prayagraj"],                        answer: 2, explanation: "Ram Mandir was inaugurated in Ayodhya on January 22, 2024 by PM Narendra Modi." },
    { id: "ca-q2",  topicId: "current-affairs", difficulty: "easy",   question: "India hosted the G20 Summit in 2023 in which city?",                        options: ["Mumbai", "New Delhi", "Bengaluru", "Hyderabad"],                       answer: 1, explanation: "India held the G20 Summit in New Delhi on September 9–10, 2023 under the 'Vasudhaiva Kutumbakam' theme." },
    { id: "ca-q3",  topicId: "current-affairs", difficulty: "medium", question: "Chandrayaan-3 successfully landed on the Moon on?",                         options: ["23 Jul 2023", "23 Aug 2023", "15 Aug 2023", "26 Nov 2023"],            answer: 1, explanation: "Chandrayaan-3 Vikram lander touched down near the Moon's South Pole on August 23, 2023." },
    { id: "ca-q4",  topicId: "current-affairs", difficulty: "medium", question: "Neeraj Chopra won which medal at Paris 2024 Olympics?",                      options: ["Gold", "Silver", "Bronze", "He didn't participate"],                   answer: 1, explanation: "Neeraj Chopra won Silver in javelin throw at Paris 2024 Olympics with a throw of 89.45m." },
    { id: "ca-q5",  topicId: "current-affairs", difficulty: "easy",   question: "ChatGPT was launched by which company?",                                    options: ["Google", "Meta", "OpenAI", "Microsoft"],                              answer: 2, explanation: "ChatGPT was launched by OpenAI on November 30, 2022 and became the fastest app to reach 100 million users." },
    { id: "ca-q6",  topicId: "current-affairs", difficulty: "hard",   question: "India's first semiconductor fab is being set up in which state?",            options: ["Maharashtra", "Karnataka", "Gujarat", "Tamil Nadu"],                   answer: 2, explanation: "Tata Electronics is building India's first semiconductor fab in Gujarat (Dholera) — approved in 2024." },
    { id: "ca-q7",  topicId: "current-affairs", difficulty: "medium", question: "India aims to become a developed nation (Viksit Bharat) by which year?",    options: ["2035", "2040", "2047", "2050"],                                        answer: 2, explanation: "Viksit Bharat (Developed India) vision targets 2047 — the 100th year of India's independence." },
    { id: "ca-q8",  topicId: "current-affairs", difficulty: "hard",   question: "India's total medal count at Paris 2024 Olympics?",                          options: ["4", "6", "7", "8"],                                                   answer: 1, explanation: "India won 6 medals at Paris 2024 — 1 silver (Neeraj Chopra) and 5 bronze medals." },
    { id: "ca-q9",  topicId: "current-affairs", difficulty: "easy",   question: "India became the 4th country to land on the Moon with which mission?",      options: ["Chandrayaan-1", "Chandrayaan-2", "Chandrayaan-3", "Aditya-L1"],        answer: 2, explanation: "Chandrayaan-3's Vikram lander made India the 4th country (after USA, USSR, China) to land on Moon in 2023." },
    { id: "ca-q10", topicId: "current-affairs", difficulty: "medium", question: "Which Indian won the Nobel Peace Prize in 2014?",                            options: ["Amartya Sen", "Kailash Satyarthi", "Malala Yousafzai", "None of these"], answer: 1, explanation: "Kailash Satyarthi won the Nobel Peace Prize in 2014 jointly with Malala Yousafzai for children's rights." },
    { id: "ca-q11", topicId: "current-affairs", difficulty: "medium", question: "Which country launched the world's first AI-regulated city in 2024?",        options: ["USA", "China", "UAE", "Singapore"],                                    answer: 2, explanation: "China's Xiong'an New Area became a major AI-integrated smart city; UAE also launched significant AI governance frameworks in 2024." },
    { id: "ca-q12", topicId: "current-affairs", difficulty: "hard",   question: "India's UPI processed how many transactions in a single day in 2024?",       options: ["50 crore", "60 crore", "70 crore", "80 crore"],                        answer: 2, explanation: "UPI crossed 70 crore daily transactions in 2024, making India the world's largest real-time payments market." },
    { id: "ca-q13", topicId: "current-affairs", difficulty: "easy",   question: "Which exam replaced AIPMT for medical admissions in India?",                 options: ["AIIMS", "NEET", "JEE", "CLAT"],                                        answer: 1, explanation: "NEET (National Eligibility cum Entrance Test) replaced AIPMT and is now the single national medical entrance exam." },
    { id: "ca-q14", topicId: "current-affairs", difficulty: "medium", question: "India's Aditya-L1 mission studies which celestial body?",                   options: ["Moon", "Mars", "Sun", "Jupiter"],                                      answer: 2, explanation: "Aditya-L1, launched in September 2023, is India's first solar observation mission placed at the L1 Lagrange point." },
    { id: "ca-q15", topicId: "current-affairs", difficulty: "hard",   question: "PM Modi launched the 'Rozgar Mela' in 2024 to provide jobs in which sector?", options: ["Private sector only", "Government sector only", "Both sectors", "Agriculture"], answer: 1, explanation: "Rozgar Mela 2024 provided appointment letters to new recruits in various Central Government departments." },
    { id: "ca-q16", topicId: "current-affairs", difficulty: "easy",   question: "India's GDP growth rate for FY 2024-25 was approximately?",                 options: ["5.4%", "6.4%", "7.4%", "8.4%"],                                       answer: 2, explanation: "India's GDP grew at approximately 6.4% in FY 2024-25, making it one of the world's fastest-growing major economies." },
  ],
};
