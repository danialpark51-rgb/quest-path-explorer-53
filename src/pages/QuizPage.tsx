...
import { ArrowLeft, Trophy, CheckCircle, XCircle, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <div className="max-w-2xl mx-auto px-4 pt-6">
        ...
        <h1 className="text-2xl font-display font-bold text-foreground mb-6">🏆 Quizzes</h1>
